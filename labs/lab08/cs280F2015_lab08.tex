...
ways in which you can improve it further. For instance, the current documentation does not show the output that
SchemaAnalyst produces when you ask it to generate a test suite. In addition, there is no detailed description the
purpose and behavior of SchemaAnalyst. Of course, the {\tt README.md} that will display on the front page of your Git
site would benefit from a terminal recording, created with {\tt asciinema}, that demonstrates the key features of the
tool.
