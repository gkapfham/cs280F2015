...
implementation.  As you know from a previous assignment, JavaNCSS is a software tool that can automatically scan your
Java source code and report information about the number of non-commented source code statements and the cyclomatic
...
values of these metrics to better understand and modify the implementation of your Java programs? How much of your
system's source code is for the program itself? How much of the source code is devoted to the test suite? 

Additionally, your external customers want you to consider assessing the quality of the test suites provided for
SchemaAnalyst.
