\input{111pre}
\begin{document}
\MYTITLE{Examination 2 Study Guide \\ Delivered: Thursday, November 12, 2015 \\ Examination: Thursday, November 19, 2015, 11:00 am}

\section*{Introduction}

This course will have its next examination on Thursday, November 19, 2015 from 11:00 to 12:15 pm. The examination will
be ``closed notes'' and ``closed book'' and it will cover the following content. Please review the ``Course Schedule''
on the course's Web site to see the content and slides that we have covered in the past modules. You may post questions
