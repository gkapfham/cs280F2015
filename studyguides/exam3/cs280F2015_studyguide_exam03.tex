\input{111pre}
\begin{document}
\MYTITLE{Examination 3 Study Guide \\ Delivered: Tuesday, December 8, 2015 \\ Examination: Friday, December 11, 2015 at 9:00 am}
...
\begin{itemize}
  ...
  \item The ability to concisely state the ``no silver bullet thesis'' that Frederick Brooks, Jr.\ develops in MMM.
    Also, a knowledge of both of some past breakthroughs that solved accidental difficulties (e.g., high-level
    languages and programming environments) and ``hopes for silver'' (e.g., expert systems) that do not fundamentally
    improve the practice of software development.
