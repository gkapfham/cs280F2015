...
\begin{itemize}
  ...
  \item The ability to concisely state the ``no silver bullet thesis'' that Frederick Brooks, Jr.\ develops in MMM.
    Also, a knowledge of both of some past breakthroughs that solved accidental difficulties (e.g., high-level languages
    and programming environments) and ``hopes for silver'' (e.g., expert systems) that do not fundamentally improve the
